...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsLayout = __webpack_require__(65);
  ...
  var _storeConfigureStore = __webpack_require__(93);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  exports.showInlineForm = showInlineForm;
  exports.hideInlineForm = hideInlineForm;
  ...
  var CLIENT_EDIT_REQUEST = 'CLIENT_EDIT_REQUEST';
  exports.CLIENT_EDIT_REQUEST = CLIENT_EDIT_REQUEST;
  var CLIENT_EDIT_SUCCESS = 'CLIENT_EDIT_SUCCESS';
  exports.CLIENT_EDIT_SUCCESS = CLIENT_EDIT_SUCCESS;
  var CLIENT_EDIT_FAILURE = 'CLIENT_EDIT_FAILURE';

  exports.CLIENT_EDIT_FAILURE = CLIENT_EDIT_FAILURE;
  ...
  exports.PATIENT_REQUEST = PATIENT_REQUEST;
  var PATIENT_SUCCESS = 'PATIENT_SUCCESS';
  exports.PATIENT_SUCCESS = PATIENT_SUCCESS;
  var PATIENT_FAILURE = 'PATIENT_FAILURE';

  exports.PATIENT_FAILURE = PATIENT_FAILURE;
  ...
  var PATIENT_EDIT_REQUEST = 'PATIENT_EDIT_REQUEST';
  exports.PATIENT_EDIT_REQUEST = PATIENT_EDIT_REQUEST;
  var PATIENT_EDIT_SUCCESS = 'PATIENT_EDIT_SUCCESS';
  exports.PATIENT_EDIT_SUCCESS = PATIENT_EDIT_SUCCESS;
  var PATIENT_EDIT_FAILURE = 'PATIENT_EDIT_FAILURE';

  exports.PATIENT_EDIT_FAILURE = PATIENT_EDIT_FAILURE;
  ...
  var EMAIL_EDIT_REQUEST = 'EMAIL_EDIT_REQUEST';
  exports.EMAIL_EDIT_REQUEST = EMAIL_EDIT_REQUEST;
  var EMAIL_EDIT_SUCCESS = 'EMAIL_EDIT_SUCCESS';
  exports.EMAIL_EDIT_SUCCESS = EMAIL_EDIT_SUCCESS;
  var EMAIL_EDIT_FAILURE = 'EMAIL_EDIT_FAILURE';

  exports.EMAIL_EDIT_FAILURE = EMAIL_EDIT_FAILURE;
  var MOBILE_EDIT_REQUEST = 'MOBILE_EDIT_REQUEST';
  exports.MOBILE_EDIT_REQUEST = MOBILE_EDIT_REQUEST;
  var MOBILE_EDIT_SUCCESS = 'MOBILE_EDIT_SUCCESS';
  exports.MOBILE_EDIT_SUCCESS = MOBILE_EDIT_SUCCESS;
  var MOBILE_EDIT_FAILURE = 'MOBILE_EDIT_FAILURE';

  exports.MOBILE_EDIT_FAILURE = MOBILE_EDIT_FAILURE;
  var MOBILE_VERIFY_REQUEST = 'MOBILE_VERIFY_REQUEST';
  exports.MOBILE_VERIFY_REQUEST = MOBILE_VERIFY_REQUEST;
  var MOBILE_VERIFY_SUCCESS = 'MOBILE_VERIFY_SUCCESS';
  exports.MOBILE_VERIFY_SUCCESS = MOBILE_VERIFY_SUCCESS;
  var MOBILE_VERIFY_FAILURE = 'MOBILE_VERIFY_FAILURE';

  exports.MOBILE_VERIFY_FAILURE = MOBILE_VERIFY_FAILURE;
  ...
  function shouldFetch(state, action) {
    var obj = action.entity && state[action.entity];
    if (!(obj && obj.data)) {
      return true;
    }
    if (obj.isFetching) {
  ...
  var SHOW_INLINE_FORM = 'SHOW_INLINE_FORM';
  exports.SHOW_INLINE_FORM = SHOW_INLINE_FORM;
  var HIDE_INLINE_FORM = 'HIDE_INLINE_FORM';

  exports.HIDE_INLINE_FORM = HIDE_INLINE_FORM;
  ...
  function showInlineForm(params) {
    return {
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _LoginPopup = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _historyLibCreateBrowserHistory = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _utilsHttp = __webpack_require__(96);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _lodashMerge = __webpack_require__(181);
  ...
  var _order = __webpack_require__(92);
  ...
  var inlineForm = function inlineForm(state, action) {
  ...
  var bookingApp = (0, _redux.combineReducers)({
    ...
    form: _reduxForm.reducer.normalize({
      ...
      inlineForm: function inlineForm(state, action) {
        switch (action.type) {
          case ActionTypes.HIDE_MODAL_DAYPICKER:
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                'div',
                { className: 'Actions-item' },
                _react2['default'].createElement('img', { src: __webpack_require__(161) }),
                _react2['default'].createElement(
                  'div',
                  { className: 'Actions-item-title' },
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _lodashSome = __webpack_require__(183);

  var _lodashSome2 = _interopRequireDefault(_lodashSome);

  var _lodashRemove = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _ConfirmPopup = __webpack_require__(19);
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              'p',
              { className: 'small' },
              'You can import pre-existing patient information.'
            )
          ),
          _react2['default'].createElement(
            'div',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _InlineForm = __webpack_require__(64);
    ...
    _createClass(BookingLocationUser, [{
      ...
      value: function render() {
        ...
        if (this.props.inlineForm && /^(userName|userEmail|userMobile)$/i.test(this.props.inlineForm.name)) {
          userDetails = _react2['default'].createElement(_InlineForm2['default'], null);
        } else {
          userDetails = _react2['default'].createElement(
            'div',
            null,
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                'div',
                { className: 'TableRowItem3' },
                this.props.user && this.props.user.clients && this.props.user.clients[0] && this.props.user.clients[0].fullName,
                ' ',
                _react2['default'].createElement(
                  'a',
                  { href: '#', onClick: this._onClickEdit.bind(this, 'userName') },
                  _react2['default'].createElement('img', { src: __webpack_require__(9) })
                )
              )
            ),
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  'a',
                  { href: '#', onClick: this._onClickEdit.bind(this, 'userEmail') },
                  _react2['default'].createElement('img', { src: __webpack_require__(9) })
                )
              )
            ),
        ...
        if (this.props.inlineForm && /^(patientName|patientGender|patientDob|patientRace|patientReligion|patientLocation)$/i.test(this.props.inlineForm.name)) {
          patientDetails = _react2['default'].createElement(_InlineForm2['default'], { fetchAddress: this.props.fetchAddress });
            ...
            patientDetails = _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    'a',
                    { href: '#', onClick: this._onClickEdit.bind(this, 'patientName') },
                    _react2['default'].createElement('img', { src: __webpack_require__(9) })
                  )
                )
              ),
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    'a',
                    { href: '#', onClick: this._onClickEdit.bind(this, 'patientGender') },
                    _react2['default'].createElement('img', { src: __webpack_require__(9) })
                  )
                )
              ),
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    'a',
                    { href: '#', onClick: this._onClickEdit.bind(this, 'patientDob') },
                    _react2['default'].createElement('img', { src: __webpack_require__(9) })
                  )
                )
              ),
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    'a',
                    { href: '#', onClick: this._onClickEdit.bind(this, 'patientRace') },
                    _react2['default'].createElement('img', { src: __webpack_require__(9) })
                  )
                )
              ),
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    'a',
                    { href: '#', onClick: this._onClickEdit.bind(this, 'patientReligion') },
                    _react2['default'].createElement('img', { src: __webpack_require__(9) })
                  )
                )
              ),
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    'a',
                    { href: '#', onClick: this._onClickEdit.bind(this, 'patientLocation') },
                    _react2['default'].createElement('img', { src: __webpack_require__(9) })
                  )
                )
              ),
      ...
      key: '_onClickSave',
      value: function _onClickSave(entity, values, dispatch) {
        var _this3 = this;

        return new Promise(function (resolve, reject) {
          switch (entity) {
            case 'userName':
              _this3.props.editClient({
                cid: _this3.props.client.id,
                fullName: values.fullName
              }).then(function (res) {
                if (res && res.response && res.response.status === 1) {
                  _this3.props.getUser().then(function () {
                    return resolve();
                  });
                } else {
            ...
            case 'userEmail':
              ...
              break;
            case 'userMobile':
              _this3.props.editMobile({
                mobilephone: values.mobilePhone
              }).then(function (res) {
                if (res && res.response && res.response.status === 1) {} else {
                  reject({ _error: res.response.message });
                }
              }, function (reason) {
                reject({ _error: reason });
            ...
            case 'patientRace':
            case 'patientReligion':
              _this3.props.editPatient(Object.assign({
                pid: _this3.state.patientId
              }, values)).then(function (res) {
                if (res && res.response && res.response.status === 1) {
                  _this3.props.getPatient({ pid: _this3.state.patientId }).then(function () {
                    return resolve();
                  });
                } else {
                  reject({ _error: res.response.message });
                ...
                return reject({ _error: reason });
              });
              break;
            case 'patientLocation':
              _this3.props.editPatient({
                pid: _this3.state.patientId,
                addresses: [Object.assign({
                  id: _this3.props.patients && _this3.state.patientId && _this3.props.patients[_this3.state.patientId] && _this3.props.patients[_this3.state.patientId].addresses && _this3.props.patients[_this3.state.patientId].addresses[0] && _this3.props.patients[_this3.state.patientId].addresses[0].id
                }, values)]
              }).then(function (res) {
                if (res && res.response && res.response.status === 1) {
                  _this3.props.getPatient({ pid: _this3.state.patientId }).then(function () {
        ...
        return new Promise(function (resolve) {
          ...
          _this4.props.createPatient({
            ...
            if (res.response && res.response.patient) {
              ...
              _this4._getPatients(_this4.props.user, function () {
                if (_this4.props.patients[patientId]) {
                  _this4.setState({
                    patientId: patientId,
                    savingPatient: false,
                    fullName: undefined,
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
      ...
      getPatient: function getPatient(params) {
        return dispatch((0, _actions.getPatient)(params));
      },
      getUser: function getUser() {
        return dispatch((0, _actions.getUser)());
      },
      editPatient: function editPatient(params) {
        return dispatch((0, _actions.editPatient)(params));
      },
      editClient: function editClient(params) {
        return dispatch((0, _actions.editClient)(params));
      },
      editEmail: function editEmail(params) {
        return dispatch((0, _actions.editEmail)(params));
      },
      editMobile: function editMobile(params) {
        return dispatch((0, _actions.editMobile)(params));
      },
      verifyMobile: function verifyMobile(params) {
        return dispatch((0, _actions.verifyMobile)(params));
      },
      ...
      showInlineForm: function showInlineForm(params) {
        return dispatch((0, _actions.showInlineForm)(params));
      }
    };
  };
...
/***/ function(module, exports, __webpack_require__) {
  ...
  exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(BookingNavigation);
  module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var BookingPatient = (function (_Component) {
    _inherits(BookingPatient, _Component);

    function BookingPatient(props) {
      _classCallCheck(this, BookingPatient);

      _get(Object.getPrototypeOf(BookingPatient.prototype), 'constructor', this).call(this, props);
      this.state = {
        agree: false
      };
    }

    _createClass(BookingPatient, [{
      key: 'render',
      value: function render() {
        var _this = this;
        ...
        return _react2['default'].createElement(
          'div',
          { className: 'BookingPatient' },
          _react2['default'].createElement(
            _Container2['default'],
            null,
            _react2['default'].createElement(
              'div',
              { className: 'BookingPatientWrapper' },
              _react2['default'].createElement(
                'div',
                { className: 'BookingPatientBody' },
                _react2['default'].createElement(_BookingPatientForm2['default'], {
                  showDayPickerPopup: this.props.showDayPickerPopup,
                  showLoginPopup: this.props.showLoginPopup,
                  showAlertPopup: this.props.showAlertPopup,
                  onNext: this._onNext.bind(this)
      ...
      value: function _onConfirmed() {
        if (this._agreeForm.checkValidity()) {
          ...
          _coreUtil2['default'].isNextLastPage('booking4', this.props.lastPage) && this.props.setLastPage('booking4');

          _coreLocation2['default'].push({ pathname: '/booking5', query: this.props.location && this.props.location.query });
        } else {
  ...
  exports['default'] = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(BookingPatient);
  module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var BookingPatientForm = (function (_Component) {
    ...
    function BookingPatientForm() {
      _classCallCheck(this, BookingPatientForm);

      _get(Object.getPrototypeOf(BookingPatientForm.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(BookingPatientForm, [{
      key: 'componentWillReceiveProps',
      value: function componentWillReceiveProps(props) {
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(
          'form',
          { className: 'BookingPatientForm', onSubmit: handleSubmit(this.props.onNext) },
          _react2['default'].createElement(
            'div',
            { className: 'BookingPatientFormSection' },
            _react2['default'].createElement(
              'div',
              null,
              'Contact Details'
            ...
            _react2['default'].createElement(
              'div',
              { className: 'BookingPatientFormGroup' },
              ...
              client_firstName.touched && client_firstName.error && _react2['default'].createElement(
                'div',
                { className: 'BookingPatientFormError' },
  ...
  exports['default'] = (0, _reduxForm.reduxForm)(reduxFormConfig, mapStateToProps)(BookingPatientForm);
  module.exports = exports['default'];
  /*
    ...
    _createClass(BookingResults, [{
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            _reactLoader2['default'],
            { className: 'spinner', loaded: this.props.sessionsFetching ? false : true },
            _react2['default'].createElement(
              'div',
              null,
                ...
                _react2['default'].createElement(
                  ...
                  sessions && sessions.map(function (session, index) {
                    return _react2['default'].createElement(
                      'div',
                      { key: index },
                      session.date && (0, _moment2['default'])(session.date, 'YYYY-MM-DD').format('DD MMM'),
                      ' - ',
                      session.time
                    );
                  })
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement('img', { src: __webpack_require__(164), className: 'Features-item-icon' }),
                _react2['default'].createElement(
                  'div',
              ...
              _react2['default'].createElement(
                'div',
                { className: 'Features-item' },
                _react2['default'].createElement('img', { src: __webpack_require__(165), className: 'Features-item-icon' }),
                _react2['default'].createElement(
                  'div',
                  { className: 'Features-item-title' },
                  'Hassle-Free'
              ...
              _react2['default'].createElement(
                'div',
                { className: 'Features-item' },
                _react2['default'].createElement('img', { src: __webpack_require__(166), className: 'Features-item-icon' }),
                _react2['default'].createElement(
                  'div',
                  { className: 'Features-item-title' },
                  'Customised Care'
              ...
              _react2['default'].createElement(
                'div',
                { className: 'Features-item' },
                _react2['default'].createElement('img', { src: __webpack_require__(167), className: 'Features-item-icon' }),
                _react2['default'].createElement(
                  'div',
                  { className: 'Features-item-title' },
                  'Verified Caregivers'
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var InlineForm = (function (_Component) {
    _inherits(InlineForm, _Component);

    function InlineForm() {
      _classCallCheck(this, InlineForm);

      _get(Object.getPrototypeOf(InlineForm.prototype), 'constructor', this).apply(this, arguments);
    }
    ...
    _createClass(InlineForm, [{
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(
          'form',
          { className: 'InlineForm', onSubmit: handleSubmit(this._handleSubmit.bind(this)) },
          _react2['default'].createElement(
            _reactLoader2['default'],
            { className: 'spinner', loaded: submitting ? false : true },
            Object.keys(fields).map(function (name) {
              ...
              switch (input.type) {
                ...
                case 'email':
                case 'hidden':
                  inputField = _react2['default'].createElement('input', _extends({ type: input.type, id: name, name: name, placeholder: input.placeholder || input.label }, field));
                  break;
                case 'select':
                  inputField = _react2['default'].createElement(
                    'div',
                    { className: 'select' },
                    _react2['default'].createElement('span', null),
                    _react2['default'].createElement(
                      'select',
                      _extends({ id: name, name: name }, field, { value: field.value || '' }),
                      _react2['default'].createElement(
                        'option',
                        { value: '' },
                        '-- Select --'
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                'button',
                { className: 'btn btn-primary', type: 'submit', disabled: submitting || pristine },
                'Save'
              ),
              _react2['default'].createElement(
                'button',
                { className: 'btn btn-primary', onClick: this._handleCancel.bind(this) },
                'Cancel'
              )
            )
          )
      ...
      value: function _handleSubmit() {
        ...
        if (this.props.onSave) {
          return this.props.onSave.apply(this, arguments).then(function () {
            _this.props.hideInlineForm();
          });
        } else if (this.props.ok) {
          return this.props.ok.apply(this, arguments).then(function () {
            _this.props.hideInlineForm();
          });
  ...
  InlineForm.propTypes = {
    ...
    inputs: _react.PropTypes.object.isRequired
  };
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
      hideInlineForm: function hideInlineForm() {
        return dispatch((0, _actions.hideInlineForm)());
      }
    };
  };

  exports['default'] = (0, _reduxForm.reduxForm)(reduxFormConfig, mapStateToProps, mapDispatchToProps)(InlineForm);
  module.exports = exports['default'];
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement('image', { clipPath: 'url(#hex-mask)', height: '120', width: '120', xlinkHref: __webpack_require__(173) })
                    )
                  )
                ),
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement('image', { clipPath: 'url(#hex-mask)', height: '120', width: '120', xlinkHref: __webpack_require__(172) })
                    )
                  )
                ),
                _react2['default'].createElement('div', null)
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement('image', { clipPath: 'url(#hex-mask)', height: '120', width: '120', xlinkHref: __webpack_require__(171) })
                    )
                  )
                ),
                _react2['default'].createElement('div', null)
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsContainerContainer = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsTestimonialsTestimonials = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsServicesServices = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  function configureStore(initialState) {
    return (0, _redux.createStore)(_reducers2['default'], initialState, (0, _redux.applyMiddleware)(_reduxThunk2['default'], _middlewareApi2['default']));
  }
